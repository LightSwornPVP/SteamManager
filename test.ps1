...
& $compiler /nologo /target:exe /reference:System.Runtime.Serialization.dll ('/out:' + $testExe) (Join-Path $PSScriptRoot 'src\Shared\Protocol.cs') (Join-Path $PSScriptRoot 'tests\ProtocolTests.cs')
