...
namespace SteamManagerDesktop
{
    ...
    [DataContract] public class DesktopPreferences { [DataMember] public List<SavedProfile> Profiles=new List<SavedProfile>(); [DataMember] public List<KeyBinding> Keys=new List<KeyBinding>(); }
    public sealed partial class MainForm
    {
        ...
        void BuildSettings()
        {
            ...
            flow.Controls.Add(new Label{Text="Profiles apply only when you choose Apply. All features start off.",AutoSize=true});var profiles=new ComboBox{Width=360,DropDownStyle=ComboBoxStyle.DropDownList};flow.Controls.Add(profiles);
