param([string]$AppDirectory=(Join-Path $PSScriptRoot '..\artifacts\preview-002'),[string]$GamePath='C:\Program Files (x86)\Steam\steamapps\common\Valheim',[string]$ProbeName='SteamManager.BehaviorProbe.dll')
