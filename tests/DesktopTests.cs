...
class DesktopQa {
 ...
 [STAThread]static int Main(string[] args){if(args.Length!=1||args[0]!="--disposable-world"){Console.Error.WriteLine("Requires --disposable-world authorization.");return 1;}Application.EnableVisualStyles();using(var form=new MainForm()){try{
